...
Re-center on protocol. Invoke at session start, every `actions_limit` actions (default 30), or when context drifts.
...
- Every `actions_limit` actions (Write, Edit, Bash; default 30) - hook enforced
